...
function devolverPrimerElemento(array) {
   ...
   // Tu código:
   var primerElementoDelArray = array.shift();
...
function devolverUltimoElemento(array) {
   ...
   // Tu código:
   var ultimoElementoDelArray = array.pop();
   return ultimoElementoDelArray;
}
...
function dePalabrasAFrase(palabras) {
   ...
   // Tu código:
   var palabrasConEspacio = palabras.join(' ');
...
function mayorACien(array) {
   ...
   // Tu código:
   var mayoresACien  = [];
   for (let masQueCien of array){
      if (masQueCien > 100){
         mayoresACien.push(masQueCien);
      }
   }
   return mayoresACien;
